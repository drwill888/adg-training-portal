...
// Creates a Stripe Checkout session for the Self-Paced Journey ($97)
// Env vars required:
//   STRIPE_SECRET_KEY
//   STRIPE_SELF_PACED_PRICE_ID  — create in Stripe dashboard, $97 one-time
...
export default async function handler(req, res) {
  ...
  try {
      ...
      : {
          price_data: {
            ...
            product_data: {
              ...
              description:
                'Seven modules of Kingdom leadership formation. Text + audio. Personalized 5C Blueprint diagnostic. Blueprint export and Certificate of Completion included.',
            },
          },
        };
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      cancel_url: `${baseUrl}/called-to-carry?canceled=true`,
