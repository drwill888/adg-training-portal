...
const diagnostic = [
  { num: 1,  cat: "Clarity & Articulation", ref: "Jeremiah 1:5",
    text: "When someone asks what I am called to do, I can answer clearly in one sentence — without hedging or over-explaining." },
  { num: 2,  cat: "Clarity & Articulation",
    text: "When an opportunity arises that does not fit my calling, I decline it — even when it is a good opportunity." },
  { num: 3,  cat: "Clarity & Articulation",
    text: "I can name at least three things I am specifically NOT called to do, and I have said no to them in the last year." },
  { num: 4,  cat: "Alignment & Grace", ref: "Romans 12:6",
    text: "My primary responsibilities in this season energize rather than drain me — they feel like grace, not grinding." },
  { num: 5,  cat: "Alignment & Grace",
    text: "I experience more flow than striving in my core assignment most weeks." },
  { num: 6,  cat: "Alignment & Grace",
    text: "I carry the weight of my calling without transferring anxiety onto the people around me." },
  { num: 7,  cat: "Confirmation & Community", ref: "1 Timothy 4:14",
    text: "My calling has been confirmed by at least one mature leader who challenged me in the process, not just encouraged me." },
  { num: 8,  cat: "Confirmation & Community",
    text: "Before major decisions, I consistently seek counsel from people capable of challenging my thinking — not just validating it." },
  { num: 9,  cat: "Confirmation & Community",
    text: "When my calling or direction is questioned by a mature leader, I genuinely consider their perspective before responding." },
  { num: 10, cat: "Conviction & Endurance", ref: "Ephesians 4:1",
    text: "Opposition and criticism have not caused me to seriously question whether I heard God correctly about my core calling." },
  { num: 11, cat: "Conviction & Endurance",
    text: "If all recognition and external validation were removed from my work, I would continue with the same faithfulness." },
  { num: 12, cat: "Conviction & Endurance", ref: "Luke 12:48",
    text: "I feel personally accountable before God for the assignments He has given me — including the ones I have delayed." },
];
