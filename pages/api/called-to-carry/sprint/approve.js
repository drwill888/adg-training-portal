    ...
    await resend.emails.send({
      ...
      html: `
        <div style="background:#021A35;color:#FDF8F0;font-family:Georgia,serif;max-width:600px;margin:0 auto;padding:3rem 2rem;">
          ...
          <p style="color:rgba(253,248,240,0.85);line-height:1.75;">Will has reviewed your application and confirmed your fit for the 21-Day Sprint. Complete your enrollment below.</p>
          <div style="margin:2rem 0;text-align:center;">
            <a href="${session.url}" style="display:inline-block;background:#C8A951;color:#021A35;padding:16px 32px;border-radius:6px;text-decoration:none;font-weight:700;font-size:1rem;">Complete Enrollment — $497 →</a>
          </div>
