...
// Will clicks the approve link → creates Stripe $497 checkout → emails applicant.
  ...
  try {
    ...
    return res.status(200).send(`
      <html><body style="font-family:Georgia,serif;max-width:600px;margin:4rem auto;padding:2rem;background:#FDF8F0;color:#021A35;">
        ...
        <p>${app.first_name} ${app.last_name} has been approved.</p>
        <p>A payment link for <strong>$497</strong> has been sent to <strong>${app.email}</strong>.</p>
