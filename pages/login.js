          ...
          {!sent ? (
            <>
              ...
              <div style={{ marginBottom: 16 }}>
                <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: colors.navy, marginBottom: 6, letterSpacing: '0.05em' }}>
                  FULL NAME
                </label>
                <input
                  type="text"
                  ...
                  style={{
                    ...
                    fontFamily: 'inherit', boxSizing: 'border-box', color: colors.navy,
                  }}
              ...
              <button
                ...
                disabled={loading}
                style={{
                  width: '100%', padding: '14px', borderRadius: 8, fontSize: 14,
                  fontWeight: 700, border: 'none', cursor: loading ? 'default' : 'pointer',
                  background: loading ? colors.gray300 : `linear-gradient(135deg, ${colors.navy}, ${colors.navyLight})`,
                  color: colors.white, transition: 'all 0.2s', fontFamily: 'inherit',
                }}
              >
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <h2 style={{ fontSize: 20, fontWeight: 700, color: colors.navy, marginBottom: 12 }}>
                Check your email
              </h2>
              <p style={{ fontSize: 14, color: colors.gray700, lineHeight: 1.7, marginBottom: 8 }}>
                We sent a sign-in link to
              </p>
              <p style={{ fontSize: 14, fontWeight: 600, color: colors.navy, marginBottom: 20 }}>
                {email}
              </p>
              <p style={{ fontSize: 13, color: colors.gray500, lineHeight: 1.6 }}>
                Click the link in the email to access your Leadership Blueprint. The link expires in 1 hour.
              </p>
              <button
                onClick={() => setSent(false)}
                style={{
                  marginTop: 24, fontSize: 13, color: colors.gold,
