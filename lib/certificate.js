...
export function downloadCertificate(userName, completionDate) {
  ...
  html += 'body { margin: 0; padding: 0; font-family: "Outfit", sans-serif; background: #FDF8F0; }';
  html += '.cert { width: 100%; max-width: 1000px; margin: 0 auto; padding: 60px; box-sizing: border-box; position: relative; min-height: 700px; background: #FDF8F0; }';
  ...
  html += '<img src="public/images/Awakening Destiny Global_ADG - Multicolor Logo.jpg" alt="ADG" style="width: 80px; height: auto; border-radius: 6px;" />';
  html += '</div>';
