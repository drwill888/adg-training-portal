...
export function downloadCertificate(userName, completionDate) {
  ...
  var logoUrl = window.location.origin + '/images/adg-logo.png';
  ...
  // Logo — colored, no inversion needed on light background
  html += '<div class="logo-area">';
  html += '<img src="' + logoUrl + '" alt="Awakening Destiny Global" style="height:44px;width:auto;" />';
  html += '</div>';
