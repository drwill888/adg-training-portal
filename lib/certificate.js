...
export function downloadCertificate(userName, completionDate) {
  ...
  var logoUrl = baseUrl + "/images/awakening%20destiny%20global_ADG-multicolor%20logo.jpg";
  ...
  html += '<img src="' + logoUrl + '" alt="ADG" style="width: 80px; height: auto; border-radius: 6px;" />';
  html += '</div>';
