// lib/module-content/competency.js
// Server-only content for the competency module (Module 3).
...
const diagnostic = [
  { num: 1,  cat: "Skill & Discipline",
    text: "I consistently set aside protected time each week to intentionally develop my skills — not just deploy them." },
  { num: 2,  cat: "Skill & Discipline", ref: "2 Timothy 2:15",
    text: "Before major responsibilities, I prepare with the same diligence I would if God Himself were directly evaluating the work." },
  { num: 3,  cat: "Skill & Discipline", ref: "Colossians 3:23",
    text: "My standard of excellence holds consistently — not only when I know people are watching." },
  { num: 4,  cat: "Execution & Reliability", ref: "Genesis 41:39–40",
    text: "The people I serve with trust my competence under pressure — not just when things are comfortable." },
  { num: 5,  cat: "Execution & Reliability",
    text: "I consistently deliver on what I commit to — even in seasons of personal difficulty or competing demands." },
  { num: 6,  cat: "Execution & Reliability",
    text: "When complexity increases, I remain calm and strategic rather than reactive and scattered." },
  { num: 7,  cat: "Systems & Sustainability", ref: "Exodus 18:21–23",
    text: "The systems I have built continue functioning even when I am not personally present to manage them." },
  { num: 8,  cat: "Systems & Sustainability",
    text: "When I delegate, I provide clear expectations, defined outcomes, and consistent follow-through — not vague handoffs." },
  { num: 9,  cat: "Systems & Sustainability",
    text: "I can organize people and process for outcomes that outlast the energy of the initial vision." },
  { num: 10, cat: "Multiplication", ref: "2 Timothy 2:2",
    text: "I can train others in the core of what I do — not just do it better than them myself." },
  { num: 11, cat: "Multiplication",
    text: "I develop leaders through reproducible process — not inspiration and relationship alone." },
  { num: 12, cat: "Multiplication",
    text: "The people I have developed are operating with growing competency in their own assignments — independent of my daily involvement." },
];
