// lib/module-content/connection.js
// Server-only content for the connection module (Module 2).
...
const diagnostic = [
  { num: 1,  cat: "Sonship & Identity", ref: "Matthew 3:17",
    text: "I consistently lead from who I am — not from what I produce or what people think of me." },
  { num: 2,  cat: "Sonship & Identity",
    text: "My confidence in my assignment does not require regular external affirmation to remain steady." },
  { num: 3,  cat: "Sonship & Identity",
    text: "When I am overlooked, criticized, or misrepresented, my sense of identity does not collapse." },
  { num: 4,  cat: "Discipline & Formation", ref: "Hebrews 12:6",
    text: "When I receive correction from a mature leader, my first response is to genuinely listen — not explain or defend." },
  { num: 5,  cat: "Discipline & Formation",
    text: "I actively seek out people who will tell me the truth over people who will agree with me." },
  { num: 6,  cat: "Discipline & Formation",
    text: "I can name a specific area in my leadership that I changed as a direct result of correction in the last 12 months." },
  { num: 7,  cat: "Security & Empowerment", ref: "Philippians 2:3",
    text: "I genuinely celebrate when someone around me advances, is promoted, or receives opportunities I did not get." },
  { num: 8,  cat: "Security & Empowerment",
    text: "I release responsibility to develop others — even when I could do the task more efficiently myself." },
  { num: 9,  cat: "Security & Empowerment",
    text: "There is no one on my team or in my sphere that I am competing with — consciously or unconsciously." },
  { num: 10, cat: "Rhythm & Abiding", ref: "Mark 1:35",
    text: "I maintain a consistent rhythm of solitude and communion with God regardless of whether my schedule cooperates." },
  { num: 11, cat: "Rhythm & Abiding",
    text: "Busyness has not consistently crowded out my time with God over the last three months." },
  { num: 12, cat: "Rhythm & Abiding", ref: "John 15:4",
    text: "I can identify the difference between the restful pace of abiding and the anxious pace of striving — and I consistently choose the former." },
];
