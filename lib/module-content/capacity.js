// lib/module-content/capacity.js
// Server-only content for the capacity module (Module 4).
...
const diagnostic = [
  { num: 1,  cat: "Resilience & Endurance", ref: "Romans 5:3–5",
    text: "I can name a recent sustained pressure that revealed something in me that I have since honestly addressed." },
  { num: 2,  cat: "Resilience & Endurance", ref: "Psalm 105:19",
    text: "When a legitimate promise or assignment has been delayed, I remain faithful without bitterness or erosion of trust." },
  { num: 3,  cat: "Resilience & Endurance",
    text: "I can receive sharp criticism without shutting down, lashing out, or withdrawing from the person who gave it." },
  { num: 4,  cat: "Emotional Maturity", ref: "Genesis 50:20",
    text: "I have genuinely forgiven — not just moved past — someone who misrepresented or betrayed me." },
  { num: 5,  cat: "Emotional Maturity", ref: "1 Samuel 24:6",
    text: "When I am provoked, I consistently choose restraint rather than reaction — and I have recent evidence of this." },
  { num: 6,  cat: "Emotional Maturity",
    text: "The people who work closest to me would describe me as emotionally regulated — not emotionally volatile." },
  { num: 7,  cat: "Humility & Growth", ref: "Proverbs 16:18",
    text: "Recent success or increased influence has not produced pride, entitlement, or decreased accountability in me." },
  { num: 8,  cat: "Humility & Growth",
    text: "The last time someone corrected me, my first response was genuine consideration — not explanation or justification." },
  { num: 9,  cat: "Humility & Growth",
    text: "As my influence has grown, my teachability has grown — not decreased." },
  { num: 10, cat: "Internal Stability", ref: "Psalm 51:10",
    text: "Adversity has not made me hard, cynical, or emotionally unavailable — I carry tenderness alongside toughness." },
  { num: 11, cat: "Internal Stability",
    text: "I manage my stress without transferring it onto the people around me." },
  { num: 12, cat: "Internal Stability", ref: "Philippians 4:11",
    text: "I carry significant responsibility without my emotional state becoming the team's daily weather forecast." },
];
