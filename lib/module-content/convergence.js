// lib/module-content/convergence.js
// Server-only content for the convergence module (Module 5).
// Imported ONLY by pages/api/modules/[slug].js — never by a page
// component — so this never ships in the client JS bundle for
// visitors who haven't been verified as paid.

const diagnostic = [
  { num: 1,  cat: "Alignment & Focus", ref: "Philippians 3:13–14",
    text: "I can state my primary assignment in this specific season in one sentence — and my schedule actually reflects it." },
  { num: 2,  cat: "Alignment & Focus",
    text: "In the last six months, I have said no to something I was capable of doing because it was outside my grace." },
  { num: 3,  cat: "Alignment & Focus",
    text: "My schedule is currently built around my priorities — not around others' urgencies or my own inability to say no." },
  { num: 4,  cat: "Integration & Stability", ref: "Psalm 1:3",
    text: "My private world — spiritual, emotional, relational — is consistent with and supports my public assignment." },
  { num: 5,  cat: "Integration & Stability",
    text: "I am carrying no more responsibility than I currently have the capacity to steward with genuine excellence." },
  { num: 6,  cat: "Integration & Stability",
    text: "The growth I am experiencing feels integrated and rooted — not chaotic, fragmented, or driven by external pressure." },
  { num: 7,  cat: "Favor & Peace", ref: "Colossians 3:15",
    text: "I make major leadership decisions from settled peace — not from urgency, fear, or the pressure of others' expectations." },
  { num: 8,  cat: "Favor & Peace",
    text: "The people who know me best would describe me as consistently steady — not unpredictable under pressure." },
  { num: 9,  cat: "Favor & Peace", ref: "Luke 2:52",
    text: "I am seeing increasing trust, open doors, and relational alignment that I did not manufacture or force." },
  { num: 10, cat: "Legacy & Succession", ref: "1 Chronicles 28:9–10",
    text: "I am actively investing in at least one person who could carry what I carry after me — not someday, but now." },
  { num: 11, cat: "Legacy & Succession", ref: "Psalm 145:4",
    text: "What I am building has structural integrity that will outlast my personal energy, presence, and season." },
  { num: 12, cat: "Legacy & Succession", ref: "Luke 12:48",
    text: "I am stewarding the influence I have been given rather than chasing expanded visibility or recognition." },
];
