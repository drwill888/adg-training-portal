// lib/module-content/commissioning.js
// Server-only content for the commissioning module (Module 6).
...
const diagnostic = [
  { num: 1,  cat: "Deployment Readiness", ref: "Matthew 28:19–20",
    text: "I can state my assignment in this season with enough specificity that someone else could confirm or challenge it." },
  { num: 2,  cat: "Deployment Readiness",
    text: "I have engaged this formation process honestly — naming what is actually true, not what sounds spiritually mature." },
  { num: 3,  cat: "Deployment Readiness",
    text: "I have identified and released at least one responsibility that is no longer mine to carry, to make room for what is." },
  { num: 4,  cat: "Kingdom Authority", ref: "Acts 13:1–3",
    text: "The authority I carry has been tested by opposition, delay, or hardship — not only declared in seasons of affirmation." },
  { num: 5,  cat: "Kingdom Authority",
    text: "I have been formally commissioned by a covering community — not just encouraged by individual supporters." },
  { num: 6,  cat: "Kingdom Authority",
    text: "The people closest to me — not just my supporters — can see the grace on my life and confirm the specific calling." },
  { num: 7,  cat: "Generational Impact", ref: "2 Timothy 2:2",
    text: "I can describe what I am building in terms of what it will produce for the generation that comes after me." },
  { num: 8,  cat: "Generational Impact",
    text: "I can name at least one person I am actively preparing to carry and extend what I carry." },
  { num: 9,  cat: "Generational Impact",
    text: "The formation I have received will be transmitted — not just demonstrated. I am building reproducible capacity in others." },
  { num: 10, cat: "Missional Clarity", ref: "John 20:21",
    text: "My assignment is specific enough that I know what to accept and what to decline — without extended deliberation." },
  { num: 11, cat: "Missional Clarity",
    text: "I am not merely inspired or motivated — I carry the settled conviction that I am sent and that this is the season." },
  { num: 12, cat: "Missional Clarity",
    text: "I know where I am sent. I know who I am sent with. I know why it matters beyond my own fulfillment." },
];
