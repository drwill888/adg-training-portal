...
<div class="guide-section">
  <div class="guide-title">SIGNAL QUICK REFERENCE</div>
  <div class="guide-grid">

    <div class="guide-card">
      <div class="gc-title" style="color:#22d3ee">CMF — Chaikin Money Flow</div>
      <div class="gc-body">Measures where close lands within the day's range, weighted by volume. Unlike simple up/down day counts — this captures HOW MUCH buying vs selling occurred each session.</div>
      <div class="gc-rows">
    ...
    <div class="guide-card">
      <div class="gc-title" style="color:#a78bfa">MFI — Money Flow Index</div>
      <div class="gc-body">RSI calculated on (Typical Price × Volume) instead of price alone. Catches overbought/oversold conditions that RSI misses when volume tells a different story.</div>
      <div class="gc-rows">
    ...
    <div class="guide-card">
      <div class="gc-title" style="color:#34d399">Up/Down Volume Ratio</div>
